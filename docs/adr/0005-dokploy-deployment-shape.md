...
The upstream AWS Terraform stack is removed. Aspire remains the local development orchestrator; `docker compose` remains for running the production images locally.
