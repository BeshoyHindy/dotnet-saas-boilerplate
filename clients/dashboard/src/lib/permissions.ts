 ...
 *
 * Platform-scoped permissions (tenant management, the cross-tenant exchange,
 * cross-tenant audits) are deliberately absent: they gate the console's screens, not
 * this app's (ADR-0008).
 */
