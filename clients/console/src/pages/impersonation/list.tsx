...
function ReopenDialog({
  ...
  const prefillUser: UserDto | undefined = grant
    ? {
        ...
        userName: grant.impersonatedUserName ?? null,
        firstName: null,
        lastName: null,
        email: null,
        phoneNumber: null,
...
function Details({ grant }: { grant: ImpersonationGrantDto }) {
  return (
    <dl className="ml-7 grid grid-cols-1 gap-y-1 border-l-2 border-[var(--color-primary)] py-2 pl-4 text-[12px] sm:grid-cols-2 sm:gap-x-6">
      <DRow label="Reason">
