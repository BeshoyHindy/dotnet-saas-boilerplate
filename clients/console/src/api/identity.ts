 ...
 * generates a reset token and mails a link to the console's `/reset-password` page.
 ...
 * parameters from the mailed link, which points at the console's own `/confirm-email`
