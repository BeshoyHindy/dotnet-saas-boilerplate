...
/** Max width of a dialog. `md` is the default and matches the pre-merge shell. */
const DIALOG_SIZES = {
  sm: "sm:max-w-sm",
  md: "sm:max-w-lg",
  lg: "sm:max-w-2xl",
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Cap the height to the viewport and scroll when content overflows, so the
        // footer stays reachable on short viewports and tall forms.
