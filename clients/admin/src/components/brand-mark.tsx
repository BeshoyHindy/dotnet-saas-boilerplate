 ...
 * the product initial, paired with the product wordmark and a small "Admin"
 * sub-label.
 *
...
/**
 * BrandMarkXL — splash version for the Login page. Leads with the product
 * wordmark, then a display monogram and a one-line system blurb.
 */
