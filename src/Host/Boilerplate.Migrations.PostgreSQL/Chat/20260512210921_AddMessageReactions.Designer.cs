...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.ChannelMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.ChatChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.MessageAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.MessageMention", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.MessageReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.ChannelMember", b =>
                {
                    b.HasOne("Boilerplate.Modules.Chat.Domain.ChatChannel", null)
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Boilerplate.Modules.Chat.Domain.MessageAttachment", b =>
                {
                    b.HasOne("Boilerplate.Modules.Chat.Domain.Message", null)
