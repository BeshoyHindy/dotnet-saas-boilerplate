...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.BillingPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.InvoiceLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.TopupRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.UsageSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.BillingPlan", b =>
                {
                    b.OwnsOne("Boilerplate.BuildingBlocks.Core.Domain.Money", "AnnualPrice", b1 =>
                        {
                    ...
                    b.OwnsOne("Boilerplate.BuildingBlocks.Core.Domain.Money", "MonthlyBasePrice", b1 =>
                        {
                            b1.Property<Guid>("BillingPlanId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.Invoice", b =>
                {
                    b.OwnsOne("Boilerplate.BuildingBlocks.Core.Domain.Money", "SubtotalAmount", b1 =>
                        {
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.InvoiceLineItem", b =>
                {
                    b.HasOne("Boilerplate.Modules.Billing.Domain.Invoice", null)
                        .WithMany("LineItems")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Boilerplate.BuildingBlocks.Core.Domain.Money", "Amount", b1 =>
                        {
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.Wallet", b =>
                {
                    b.OwnsOne("Boilerplate.BuildingBlocks.Core.Domain.Money", "Balance", b1 =>
                        {
            ...
            modelBuilder.Entity("Boilerplate.Modules.Billing.Domain.WalletTransaction", b =>
                {
                    b.HasOne("Boilerplate.Modules.Billing.Domain.Wallet", null)
