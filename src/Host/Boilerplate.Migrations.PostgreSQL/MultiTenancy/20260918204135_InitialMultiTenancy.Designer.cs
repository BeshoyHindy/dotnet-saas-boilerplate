...
namespace Boilerplate.Migrations.PostgreSQL.MultiTenancy
{
    ...
    [Migration("20260918204135_InitialMultiTenancy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Boilerplate.BuildingBlocks.Shared.Multitenancy.AppTenantInfo", b =>
                {
            ...
            modelBuilder.Entity("Boilerplate.Modules.Multitenancy.Domain.TenantExpiryNotice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Multitenancy.Domain.TenantTheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Multitenancy.Provisioning.TenantProvisioning", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Boilerplate.Modules.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.HasOne("Boilerplate.Modules.Multitenancy.Provisioning.TenantProvisioning", "Provisioning")
                        .WithMany("Steps")
