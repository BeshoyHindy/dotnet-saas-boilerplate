...
public sealed class Notification : AggregateRoot<Guid>
{
    ...
    /// <summary>Logical event type, e.g. <c>files.upload_finalized</c>. Used by the UI to pick an icon.</summary>
    ...
    /// <summary>Originating module name (e.g. <c>Files</c>) — for grouping + filtering.</summary>
