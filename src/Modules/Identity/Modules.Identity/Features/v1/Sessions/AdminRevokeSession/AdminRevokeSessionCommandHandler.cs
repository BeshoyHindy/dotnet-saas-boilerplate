...
using Boilerplate.Modules.Identity.Contracts.v1.Sessions.AdminRevokeSession;
using Mediator;

namespace Boilerplate.Modules.Identity.Features.v1.Sessions.AdminRevokeSession;
