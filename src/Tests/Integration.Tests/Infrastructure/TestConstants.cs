...
public static class TestConstants
{
    ...
    /// <summary>
    /// What the test host configures as <c>Seed:DemoPassword</c> — the one password every demo
    /// account created by the migrator's <c>--demo</c> flag signs in with.
    /// </summary>
    public const string DemoPassword = "Demo$eed2026";
