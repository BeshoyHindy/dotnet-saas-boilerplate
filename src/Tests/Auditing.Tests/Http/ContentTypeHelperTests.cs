...
public sealed class ContentTypeHelperTests
{
    ...
    {
        var assembly = typeof(Boilerplate.Modules.Auditing.AuditingModule).Assembly;
        var helperType = assembly.GetType("Boilerplate.Modules.Auditing.ContentTypeHelper");
