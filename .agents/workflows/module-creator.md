...
You orchestrate a full module bring-up for Boilerplate. **The code recipe lives in the `add-module`
...
dotnet run --project src/Host/Boilerplate.DbMigrator -- list-pending   # new context shows up
```
